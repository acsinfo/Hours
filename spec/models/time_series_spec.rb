describe TimeSeries do
  ...
  before(:each) do
    ...
    create(:hour, value: 6, starting_time: DateTime.new(2014, 1, 1), user: user)
    create(:hour, value: 2, starting_time: DateTime.new(2014, 1, 1), user: user)
    create(:hour, value: 5, starting_time: DateTime.new(2014, 1, 3), user: user)
    create(:hour, value: 5, starting_time: DateTime.new(2013, 11, 3), user: user)
    create(:hour, value: 5, starting_time: DateTime.new(2013, 12, 13), user: user)
  end
